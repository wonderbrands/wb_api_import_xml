...
<<<<<<< HEAD:invoices_functions/reverse_invoices/invoice_reverse_nc.py
print('================================================================')
...
>>>>>>> parent of da6750c... [UPD] Agrega archivo para creación de NC en INV globales:Invoices/invoice_reverse_nc.py
